...
export const metadata:Metadata={metadataBase:new URL("https://cvolt-ats-cv.netlify.app"),alternates:{canonical:"/"},verification:{google:"Tov0yAGszSiqfmTlFnKg_yMBPdfQteNjsFS5Byw3ZWI"},title:"CVOLT — Free ATS-Friendly CV Builder",description:"Create a clean, professional, ATS-friendly CV for free. No registration, no hidden fees, and your information is never permanently stored.",icons:{icon:"/favicon.svg"},openGraph:{title:"Build an ATS-Friendly CV for Free",description:"No registration • Free PDF • Private by design",images:["/og.png"]},twitter:{card:"summary_large_image",title:"Build an ATS-Friendly CV for Free",description:"No registration • Free PDF • Private by design",images:["/og.png"]}};
